var app = angular.module('nibs', ['ionic', 'openfb', 'nibs.openline', 'nibs.config', 'nibs.profile', 'nibs.auth', 'nibs.product', 'nibs.offer', 'nibs.store-locator', 'nibs.gallery', 'nibs.settings', 'nibs.case'])

    .run(function ($window, $location, $rootScope, $state, $ionicPlatform, $http, OpenFB, OpenLINE, FB_APP_ID, LINE_CHANNEL_ID, SERVER_URL) {
