var app = angular.module('nibs', ['ionic', 'openfb', 'openline', 'nibs.config', 'nibs.profile', 'nibs.auth', 'nibs.product', 'nibs.offer', 'nibs.store-locator', 'nibs.gallery', 'nibs.settings', 'nibs.case'])
    ...
    .run(function ($window, $location, $rootScope, $state, $ionicPlatform, $http, OpenFB, OpenLINE, FB_APP_ID, LINE_CHANNEL_ID, LINE_CHANNEL_SECRET, LINE_LOGIN_URL, LINE_GET_TOKEN_URL, LINE_GET_USER_URL, CALLBACK_URL, SERVER_URL) {
        ...
        OpenLINE.init(LINE_CHANNEL_ID, LINE_CHANNEL_SECRET, LINE_LOGIN_URL, LINE_GET_TOKEN_URL, LINE_GET_USER_URL, CALLBACK_URL);
